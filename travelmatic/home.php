...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="homerestaurants.php">Restaurants<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="homeconcerts.php">Concerts<span class="sr-only">(current)</span></a>
      </li>
    </ul>
	...
	<h5> Hi <?php echo $userRow['firstName']. "!" ; ?> </h5>
